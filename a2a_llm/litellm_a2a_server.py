...
def parse_args() -> Args:
    ...
    parser.add_argument('--model-name', type=str, default=None, help='Name of model to serve.')
...
if __name__ == "__main__":
    ...
    model_name = args.model_name if args.model_name else os.environ["MODEL_NAME"]
    llm_agent = LitellmAgent(model_name=model_name, api_key=args.api_key, api_base_url=args.api_base_url, api_version=args.api_version)
